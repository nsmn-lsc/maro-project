...
ALTER TABLE consultas_prenatales
  ADD COLUMN longitud_cervical DECIMAL(5,2) DEFAULT NULL COMMENT 'Longitud cervical en mm' AFTER color_piel,
  ADD COLUMN fc_fetal VARCHAR(20) DEFAULT NULL COMMENT 'Frecuencia cardíaca fetal en lpm' AFTER longitud_cervical,
  ADD COLUMN bh VARCHAR(100) DEFAULT NULL COMMENT 'Biometría Hemática' AFTER edema;
