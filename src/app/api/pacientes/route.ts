...
export async function GET(request: Request) {
  ...
  try {
    ...
    const selectFields = idFilter ? `
      ...
      p.factor_endocrinopatia, p.factor_neumopatia, p.factor_its, p.factor_cirugias_pelvico_uterinas, p.factor_discapacidad,
      p.otros_antecedentes,
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const payload = {
      ...
      ant_embarazo_ectopico: body.ant_embarazo_ectopico ? 1 : 0,
      ...
      factor_endocrinopatia: body.factor_endocrinopatia ? 1 : 0,
      factor_neumopatia: body.factor_neumopatia ? 1 : 0,
      factor_its: body.factor_its ? 1 : 0,
      factor_cirugias_pelvico_uterinas: body.factor_cirugias_pelvico_uterinas ? 1 : 0,
      factor_discapacidad: body.factor_discapacidad ? 1 : 0,
      otros_antecedentes: body.otros_antecedentes ? String(body.otros_antecedentes).trim().slice(0, 50) : null,
