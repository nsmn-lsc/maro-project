...
export default function ContadorRiesgo({ formData, onPuntajeChange, isInline = false }: ContadorRiesgoProps) {
  ...
  const datosFactores: DatosFactoresPaciente = useMemo(() => ({
    ...
    ant_embarazo_ectopico: formData.ant_embarazo_ectopico === true,
    // Factores de riesgo
    ...
    factor_endocrinopatia: formData.factor_endocrinopatia === true,
    factor_neumopatia: formData.factor_neumopatia === true,
    factor_its: formData.factor_its === true,
    factor_cirugias_pelvico_uterinas: formData.factor_cirugias_pelvico_uterinas === true,
    factor_discapacidad: formData.factor_discapacidad === true,
    ...
    formData.ant_embarazo_ectopico,
    ...
    formData.factor_endocrinopatia,
    formData.factor_neumopatia,
    formData.factor_its,
    formData.factor_cirugias_pelvico_uterinas,
    formData.factor_discapacidad,
